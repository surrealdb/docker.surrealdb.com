...
aws lambda --region us-east-1 update-function-configuration --function-name docker-surrealdb-com --runtime nodejs22.x --handler index.main --timeout 5 --memory-size 512 && sleep 3
